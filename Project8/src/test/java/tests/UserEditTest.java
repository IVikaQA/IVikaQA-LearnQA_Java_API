...
public class UserEditTest extends BaseTestCase {
    ...
    public void testEditUserWithoutAuthorization() {
        ...
        Response responseEdit = RestAssured
                .given()
                .body(editData)
                .put("https://playground.learnqa.ru/api_dev/user/1") // Используйте ID пользователя < 10
                .andReturn();
    ...
    public void testEditEmailWithoutAtSymbol() {
        ...
        // 2) Попытка изменить email на некорректный
        System.out.println("Шаг 2: Попытка изменить email на некорректный (без символа @)");
        Map<String, String> editData = new HashMap<>();
