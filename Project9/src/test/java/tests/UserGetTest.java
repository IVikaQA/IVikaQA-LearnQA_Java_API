...
public class UserGetTest extends BaseTestCase {
    ...
    @Test
    @DisplayName("Тест: Получение данных пользователя, когда мы НЕ АВТОРИЗОВАНЫ")
    @TmsLink("Ex16")
    ...
    /*
    Мы должны сделать запрос на авторизацию с логин="https://playground.learnqa.ru/api/user/"
    и пароль=1234
   и в последующие запросы подставлять куки и header
     */
    @Test
    @DisplayName("Тест: Получение данных,когда мы АВТОРИЗОВАНЫ")
    @TmsLink("Ex16")
    ...
    @Test
    @DisplayName("Тест: Метод авторизуется под одним пользователем и запрашивает данные другого пользователя")
    @TmsLink("Ex16")
