...
public class UserRegisterTest extends BaseTestCase {
    ...
    @Test
    @DisplayName("Тест3: Создание пользователя с некорректным email - без символа @")
    @TmsLink("Ex15")
    ...
    @DisplayName("Тест4: Создание пользователя без указания обязательного поля {username,email,password}")
    @TmsLink("Ex15")
    ...
    @Test
    @DisplayName("Тест5: Создание пользователя с коротким именем в один символ")
    @TmsLink("Ex15")
    ...
    @Test
    @DisplayName("Тест6: Создание пользователя с длинным именем - длиннее 250 символов")
    @TmsLink("Ex15")
